...
<head>
  ...
  <title>Dashboard - RS NUSANTARA</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="/assetsDashboard/img/logors.png" rel="icon">
  <link href="/assetsDashboard/img/logors.png" rel="logors">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="/dashboard" class="logo d-flex align-items-center">
        <img src="/assetsDashboard/img/logors.png" alt="">
        <span class="d-none d-lg-block">RS - NUSANTARA</span>
      </a>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>PT TERUS BERGERAK</span></strong>. All Rights Reserved
    </div>
  </footer><!-- End Footer -->
